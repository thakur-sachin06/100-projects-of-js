...
const computerChoiceArray = ["rock", "paper", "scissor", "lizard", "spock"];
...
function displayComputerChoice(computerChoice) {
  switch (computerChoice) {
    ...
    case "lizard":
      ...
      computerChoiceText.textContent = " --- Lizard";
      break;

    case "spock":
      computerSpock.classList.add("selected");
      computerChoiceText.textContent = " --- Spock";
      break;

    case "scissor":
      computerScissor.classList.add("selected");
      computerChoiceText.textContent = " --- Scissor";
      break;
...
function computerRandomChoice() {
  const computerChoiceNum = Math.floor((Math.random() * 10) % 5);
  computerChoice = computerChoiceArray[computerChoiceNum];
...
// select function is called in html from each icon with am their name(rock, paper.....).
function displayPlayerChoice(playerChoice) {
  ...
  switch (playerChoice) {
    ...
    case "lizard":
      ...
      playerChoiceText.textContent = " --- Lizard";
      break;

    case "spock":
      playerSpock.classList.add("selected");
      playerChoiceText.textContent = " --- Spock";
      break;
